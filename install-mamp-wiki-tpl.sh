...
git clone git@github.com:theironyard/wiki-template.git /Applications/MAMP/htdocs/lib/tpl/bootstrap3
...
2. RUN THE INSTALLER
3. START CODING on files at /Applications/MAMP/htdocs/lib/tpl/bootstrap3
-------------------'
